...
If you have made changes, you need to re-do all the steps from the Instructions section below, then re-apply your changes. Alternatively, you can stash your changes, pull, then apply the stashed changes and remove any conflicts you might encounter.
